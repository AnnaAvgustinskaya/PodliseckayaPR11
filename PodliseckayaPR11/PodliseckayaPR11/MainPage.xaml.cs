...
namespace PodliseckayaPR11
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            var rnd = new Random();
            var data = new[] { "Группа: ПКС-31", "ФИО: Подлисецкая Анна Владимировна", "Программист со стажем", "Безработный", "В активном поиске", $"Сегодня:{DateTime.Now}" };
